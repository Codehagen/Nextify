...
export const Icons = {
  ...
  Check: Lucide.Check,
  Copy: Lucide.Copy,
  CopyDone: Lucide.ClipboardCheck,
  Sun: Lucide.SunMedium,
  Moon: Lucide.Moon,
  Key: Lucide.Key,
  spinner: Lucide.Loader2,
  ...
  Address: Lucide.MapPin,
  LinkedIn: Lucide.Linkedin,
  Facebook: Lucide.Facebook,
  Globe: Lucide.Globe,
  Briefcase: Lucide.Briefcase,
  Note: Lucide.ScrollText,
  Task: Lucide.ListTodo,

  gitHub: (props: Lucide.LucideProps) => (
